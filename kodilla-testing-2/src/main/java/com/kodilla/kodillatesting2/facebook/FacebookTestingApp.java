...
public class FacebookTestingApp {
    ...
    public static final String XPATH_CREATE = "//div[contains(@class, \"_6ltg\")]/a";
    ...
    public static void main(String[] args) {
        ...
        WebElement accountCreation = driver.findElement(By.xpath(XPATH_CREATE));
